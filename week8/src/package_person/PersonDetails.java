...
public class PersonDetails {
    ...
    public static void main(String[] args) {
        ...
        // in the process of creating an abject from my Person class
...
//        System.out.println(secondPerson.creditScore);
        ...
        System.out.println(thirdPerson.assumeGender(adjustedRate) + thirdPerson.getRate(monthlyRate)+ " dollars");
